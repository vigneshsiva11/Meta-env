...
ContractAction(
    action_type: Literal[
        ...
        "rename_field",    # ♻️  Rename + auto-add backward-compat alias
...
- Server boots in <2 seconds; typical full run = 40–50 seconds
...
2. **Real-World Strategy Transfer** — Agents learn aliasing, deprecation headers, and version merging—strategies that directly apply to production API evolution.
